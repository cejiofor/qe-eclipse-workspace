...
<body>
	...
	<form action="${pageContext.request.contextPath}/HomeServlet/updateMember" method="post">
		<div>
	...
	<a href="${pageContext.request.contextPath}/HomeServlet/showProfile">Back to Member Profile</a>
